...
const projects = [
  {
    ...
    description:
      "A VS Code extension that uses AI to help developers write better code faster. Features include code completion, refactoring suggestions, and documentation generation.",
    image: "/placeholder.svg?height=600&width=800",
    tags: ["TypeScript", "React", "OpenAI API", "VS Code API"],
    demoLink: "#",
    githubLink: "#",
  },
  {
    ...
    description:
      "A responsive dashboard for monitoring and visualizing data from various sources. Includes real-time updates, customizable widgets, and AI-powered insights.",
    image: "/placeholder.svg?height=600&width=800",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            A selection of my recent work showcasing both traditional development and AI-powered solutions.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <AnimatedGradientBorder borderWidth={2} animationDuration={10 + index * 2}>
